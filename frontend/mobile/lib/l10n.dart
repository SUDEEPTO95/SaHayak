...
class L {
  ...
  String get needSub => hi
      ? "अस्पताल ने रक्त माँगा। पहले आपके भरोसे के लोग।"
      : "Hospital asked for blood. We start with people you trust.";
  String get donate => hi ? "मैं दे सकता/सकती हूँ" : "I can donate";
  String get donSub => hi
      ? "मैं दे सकता/सकती हूँ। फोन तब तक छिपा जब तक मैं कहूँ कि मैं जाऊँगा/जाऊँगी।"
      : "I can give. My phone stays hidden until I say I can go.";
  String get more =>
      hi ? "और — आपात नहीं" : "More — extra help, not the emergency";
  ...
  String get paste =>
      hi ? "व्हाट्सऐप संदेश (वैकल्पिक)" : "Paste a WhatsApp message (optional)";
  String get fillForm =>
      hi ? "फॉर्म भरें — अभी नहीं भेजा" : "Fill the form — not sent yet";
  String get send => hi ? "भेजें" : "Send";
  String get sendSub =>
      hi ? "विश्वसनीय लोग पहले सुनें" : "trusted people hear first";
  String get home => hi ? "होम" : "Home";
  String get skipPings =>
      hi ? "आज पिंग न करें (बुखार/व्रत)" : "Self-hold (skip pings)";
  ...
  String get slipFill =>
      hi ? "पर्ची से भरें — अभी नहीं भेजा" : "Fill from the paper — not sent";
  ...
  String get restAndRecover => hi
      ? "आराम करो। ठीक हो जाने के बाद ही आएँ।"
      : "Rest and recover. Come back later.";
  ...
  String get mapsOff =>
      hi ? "मैप बंद। शहर सूची का उपयोग करें।" : "Maps off. Use city list.";
  String get deadButton =>
      hi ? "अभी उपलब्ध नहीं है" : "Not available right now";
  String get womenFirst => hi ? "महिला पहले" : "Women first";
  String get sameEmergency =>
      hi ? "दो फोन से एक ही आपात" : "Same emergency from two phones";
